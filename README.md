...
| 软件成本 | ¥3,000-8,000/年/店 | 试点约¥60/年/店；规模化约¥420-600/年/店（**降低97%+**） |
...
本方案不声称"零成本"——飞书AI服务、大模型API调用均有真实费用。以下是严谨的成本拆解：

| 飞书AI服务 | 定价（2026年7月） | 本方案使用场景 |
|-----------|-----------------|--------------|
| 多维表格基础版 | **免费**（20人，200次自动化/月） | 试点阶段（≤20店） |
| 多维表格专业版 | 35元/人/月（100人，5000次自动化/月） | 规模化阶段 |
| aily智能体 | AI基础版9,900元/年（企业级） | AI导购对话 |
| 妙搭低代码 | 限时免费（每日100万Tokens） | 巡检表单应用 |
| 通义千问API | 输入0.40元/百万Tokens，输出1.60元/百万Tokens | 大模型调用 |

**单店成本测算：**
- **试点阶段（≤20店）**：利用多维表格免费额度 + 妙搭免费额度，主要支出为API调用（按单店日均20次对话、每次约2000 Tokens估算，月均约1元），**单店年成本约60元**
- **规模化阶段（100+店）**：多维表格专业版35元/人/月 + aily企业版均摊，**单店年成本约420-600元**
- **对比传统方案**：硬件¥8,000-15,000 + 软件¥3,000-8,000/年 + 部署+培训，单店首年¥11,000-23,000+，**本方案降低97%+**
